...
class DirectionMaskTests {
    private val horizontalDirectionList = RelativeDir.values().filter { it.isHorizontal }
    private val verticalDirectionList = RelativeDir.values().filter { it.isVertical }
