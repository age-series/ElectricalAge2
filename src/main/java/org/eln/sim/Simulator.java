...
import org.eln.sim.mna.RootSystem;
...
import org.eln.sim.process.destruct.IDestructable;
import org.eln.sim.thermal.ThermalConnection;
...
public class Simulator /* ,IPacketHandler */ {
    ...
    public void addThermalConnection(ThermalConnection connection) {
        if (connection != null) {
            if (connection.L1.isSlow() == connection.L2.isSlow()) {
                ...
                System.out.println("***** addThermalConnection ERROR ****");
            }
        }
    }
    ...
    public void tick(TickEvent.ServerTickEvent event) {
        ...
        if (++printTimeCounter == 20) {
            ...
            System.out.println("ticks " + new DecimalFormat("#").format((int) avgTickTime) + " us" + "  E " + electricalNsStack / 1000 + "  TF " + thermalFastNsStack / 1000 + "  TS " + thermalSlowNsStack / 1000 + "  S " + slowNsStack / 1000
