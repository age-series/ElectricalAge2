package org.eln2.mc.content.cell.solar_panel
...
class SolarPanelCell(pos : BlockPos) : CellBase(pos) {
    ...
    */
    ...
    override fun componentForNeighbour(neighbour: CellBase): ElectricalComponentConnection {
        val circuit = graph.circuit

        return ElectricalComponentConnection(neighbourToResistorLookup.computeIfAbsent(neighbour) {
